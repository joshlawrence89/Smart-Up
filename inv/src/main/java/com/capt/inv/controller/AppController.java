...
public class AppController {
	...
	String deleteuser(@RequestParam int id, RedirectAttributes redirect) {
	...
	String del(@PathVariable int id, RedirectAttributes redirect) {
	...
	String editrole(@RequestParam String role, @RequestParam int id, RedirectAttributes redirect) {
	...
	public String addprofileImg(@RequestParam MultipartFile file, @RequestParam int id, RedirectAttributes model) {
	...
	String addcarding(@RequestParam("cardno") String cardno, @RequestParam String secode, @RequestParam String expiry,
			@RequestParam int id, RedirectAttributes red) {
	...
	String removecard(@PathVariable int id, RedirectAttributes red) {
