			...
			<div id="home_slider"
				...
				<ul>
					...
					<li data-index="rs-73" data-thumb="images/slider/slider-1.jpg"
						...
						<!-- MAIN IMAGE --> <img src="static/images/slider/slider-1.jpg"
						...
						data-height="50px" data-whitespace="normal" data-type=""
					...
					<li data-index="rs-74" data-transition="fade"
						...
						<!-- MAIN IMAGE --> <img src="static/images/slider/slider-3.jpg"
						alt="" data-bgposition="cover" data-bgfit="cover"
						data-bgrepeat="no-repeat" data-bgparallax="on" class="rev-slidebg"
					...
					<li data-index="rs-75" data-transition="fade"
						...
						<!-- MAIN IMAGE --> <img src="static/images/slider/slider-2.jpg"
						data-bgposition="center center" data-bgfit="cover"
						data-bgrepeat="no-repeat" data-bgparallax="on" class="rev-slidebg"
						data-no-retina alt="slider img" /> <!-- LAYERS --> <!-- LAYER NR. 10 -->
						<div class="" id="slide-75-layer-2"
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="category-box">
						<a href=""> <img
							src="static/images/shop/category/category-1.jpg" alt="" />
							<div class="content">
								<h3></h3>
								<p></p>
							</div>
					...
					<div class="category-box">
						<a href=""> <img
							src="static/images/shop/category/category-2.jpg" alt="" />
							<div class="content">
								<h3></h3>
								<p></p>
							</div>
				...
				<div class="col-md-6">
					<div class="category-box category-box-2">
						<a href=""> <img
							src="static/images/shop/category/category-3.jpg" alt="" />
							<div class="content">
								<h3></h3>
								<p></p>
							</div>
			...
			<div class="row">
				...
				<div class="col-md-4">
					<div class="product-item">
						<div class="product-thumb">
							<span></span> <img class="img-responsive"
								src="static/images/shop/products/product-1.jpg"
								alt="product-img" />
					...
					<div class="product-item">
						<div class="product-thumb">
							<img class="img-responsive"
								src="static/images/shop/products/product-2.jpg"
								alt="product-img" />
							<div class="preview-meta">
								<ul>
									<li><span data-toggle="modal" data-target="#product-modal">
						...
						<div class="product-content">
							<h4>
								<a href="product-single.html">Trending #2</a>
							</h4>
							<p class="price"></p>
						</div>
					</div>
				...
				<div class="col-md-4">
					<div class="product-item">
						<div class="product-thumb">
							<img class="img-responsive"
								src="static/images/shop/products/product-3.jpg"
								alt="product-img" />
							<div class="preview-meta">
								<ul>
									<li><span data-toggle="modal" data-target="#product-modal">
						...
						<div class="product-content">
							<h4>
								<a href="product-single.html">Trending #3</a>
							</h4>
							<p class="price"></p>
						</div>
					</div>
