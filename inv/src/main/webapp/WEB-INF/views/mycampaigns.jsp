				...
				<div class="dashboard-wrapper user-dashboard">
					<div class="table-responsive">
						<table class="table">
							...
							<tbody>
								<c:forEach items="${mycampaigns}" var="newcampaign">
								<tr>
									<td>${newcampaign.projectId}</td>
									<td>${newcampaign.projectName}</td>
									<td>${newcampaign.dateCreation.toString().substring(0,10)}</td>
									<td>${newcampaign.targetAmount}</td>
									<td>${newcampaign.pledges}</td>
									<td>${newcampaign.status}</td>
									<td></td>
									<td><a href="editcampaign/${newcampaign.projectId}" class="btn btn-default">Edit</a></td>
								</tr>
								</c:forEach>
							</tbody>
						</table>
